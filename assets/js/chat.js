...
(function () {
  ...
  var KB = [
    ...
    { id: 'industries', kw: ['industry', 'industries', 'medical', 'clinic', 'health', 'travel', 'tour', 'retail', 'shop', 'store', 'ecommerce', 'e-commerce', 'online store', 'marketplace', 'restaurant', 'hotel', 'construction', 'contractor', 'f&b', 'fnb', 'food', 'cafe', 'kitchen', 'manufactur', 'factory', 'wellness', 'spa', 'gym', 'studio'],
    ...
    { id: 'marketing', kw: ['website', 'web design', 'social media', 'marketing', 'facebook', 'linkedin', 'instagram', 'seo', 'landing page', 'logo', 'brand', 'branding', 'deck', 'brochure', 'graphic'],
      ...
      actions: [['link', 'solutions/website.html', 'Web design'], ['link', 'solutions/social-media.html', 'Social media'], ['link', 'solutions/brand-assets.html', 'Brand assets'], ['talk']], next: ['price', 'human'] },
    { id: 'ai', kw: ['ai', 'artificial', 'chatgpt', 'automation', 'agent', 'llm', 'claude', 'ocr', 'rag', 'chatbot', 'knowledge', 'assistant', 'workflow'],
      ...
      actions: [['link', 'solutions/ai.html', 'AI solutions'], ['link', 'solutions/ai-knowledge.html', 'Knowledge assistants'], ['link', 'solutions/ai-chatbots.html', 'Chatbots'], ['talk']], next: ['how', 'human'] },
    { id: 'contact', kw: ['contact', 'email', 'phone', 'whatsapp', 'address', 'location', 'where', 'singapore', 'call', 'reach'],
      a: 'Email <a href="mailto:sales@technext.asia">sales@technext.asia</a> · WhatsApp <a href="https://wa.me/6588396998" target="_blank" rel="noopener">+65 8839 6998</a> · 261 Waterloo Street #03-36, Singapore 180261. Headquartered in Singapore, serving clients globally.',
